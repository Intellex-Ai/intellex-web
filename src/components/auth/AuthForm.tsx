    ...
    return (
        <div className="w-full space-y-4">
            <div className="grid grid-cols-2 gap-3">
                <Button variant="secondary" className="w-full border-white/10 hover:bg-white/5 hover:border-white/20 transition-all duration-300" leftIcon={<Github size={16} />}>
                    GITHUB
                </Button>
                <Button variant="secondary" className="w-full border-white/10 hover:bg-white/5 hover:border-white/20 transition-all duration-300" leftIcon={
