...
export default function Navbar() {
    ...
    const mobileMenuClassName =
        'lg:hidden fixed top-0 left-0 w-screen h-screen bg-black z-[100] flex flex-col items-center justify-center p-8 border-l border-white/10 menu-slide-in';
    ...
    return (
        <nav className={navClasses}>
            <div className="w-full m-0 px-4 lg:px-12 flex items-center justify-between h-full max-w-[1400px] mx-auto">
                ...
                {/* Mobile Menu Overlay */}
                {isMenuOpen && (
                    <div className={mobileMenuClassName} role="dialog" aria-modal="true">
